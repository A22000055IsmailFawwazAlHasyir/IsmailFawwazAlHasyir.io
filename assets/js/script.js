...
function showBarang() {
  ...
  listBarang.innerHTML = "<tr><th>Nama</th><th>Dus</th><th>Total</th><th>Action</th></tr>";
...
function cekTotalHarga(jenisBarang, jumlah) {
  if (jenisBarang == "Mie") {
  ...
  } else if (jenisBarang == "Kopi") {
    const total = jumlah * 180000;
    return {
      nama_barang: jenisBarang,
      jumlah: jumlah,
      total: total,
    };
  } else if (jenisBarang == "Rokok") {
  ...
  } else if (jenisBarang == "Minyak Goreng") {
    ...
    const total = jumlah * 200000;
    return {
      nama_barang: jenisBarang,
      jumlah: jumlah,
      total: total,
    };
  } else if (jenisBarang == "Air Mineral") {
    const total = jumlah * 150000;
    return {
      nama_barang: jenisBarang,
      jumlah: jumlah,
